...
export function activateMappersAndEndpoints(viewManager: ViewManager, providerManager: ProviderManager, workspaceFolder: string, middlewareName: string) {
      // Register Mapper Tree
      const defaultMapperTreeDataProvider = providerManager.createMapperTreeDataProvider(workspaceFolder, middlewareName);
